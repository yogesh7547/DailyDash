...
fetch("https://api.weatherapi.com/v1/current.json?key=794ecc358ea146be9a391627252104&q=mumbai&aqi=no")
.then((response)=>{
...
let fullDate= `${day}/${month}<br><span>${year}</span>`

document.querySelector(".date-time").innerHTML=fullDate;